...
class User(AbstractUser):
    ...
    status = models.CharField(max_length=20, choices=UserStatus.choices, default=UserStatus.PENDING_VERIFICATION)
...
class UserPermissionGroup(models.Model):
    ...
    name = models.CharField(max_length=100)
    description = models.TextField(blank=True)
    hospital = models.ForeignKey('hospitals.Hospital', on_delete=models.CASCADE, related_name='permission_groups')
...
class UserCredential(models.Model):
    ...
    credential_type = models.CharField(max_length=100)  # e.g., 'Medical License', 'Board Certification'
