...
from sentry_sdk.utils import (ContextVar, capture_internal_exception,
                              ...
                              disable_capture_event, event_from_exception,
                              exc_info_from_error, logger)
...
if TYPE_CHECKING:
    ...
    import sentry_sdk
    from sentry_sdk._types import (Breadcrumb, BreadcrumbHint, ErrorProcessor,
                                   Event, EventProcessor, ExcInfo, Hint,
                                   LogLevelStr, SamplingContext, Type)
