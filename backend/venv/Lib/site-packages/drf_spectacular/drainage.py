...
if sys.version_info >= (3, 8):
    from typing import Final  # type: ignore[attr-defined] # noqa: F401
    from typing import Literal, TypedDict, _TypedDictMeta
else:
    from typing_extensions import TypedDict  # noqa: F401
    from typing_extensions import Final, Literal, _TypedDictMeta
