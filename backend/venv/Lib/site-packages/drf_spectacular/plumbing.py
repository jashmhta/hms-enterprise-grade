...
from typing import (Any, DefaultDict, Dict, Generic, List, Optional, Sequence,
...
from django.urls.resolvers import (  # type: ignore[attr-defined]
    _PATH_PARAMETER_COMPONENT_RE, RegexPattern, Resolver404, RoutePattern,
    URLPattern, URLResolver, get_resolver)
...
from drf_spectacular.types import (DJANGO_PATH_CONVERTER_MAPPING,
                                   OPENAPI_TYPE_MAPPING, PYTHON_TYPE_MAPPING,
                                   OpenApiTypes, _KnownPythonTypes)
from drf_spectacular.utils import (OpenApiExample, OpenApiParameter,
                                   OpenApiWebhook, _FieldType,
                                   _ListSerializerType, _ParameterLocationType,
...
if sys.version_info >= (3, 8):
    ...
    from typing import \
        _TypedDictMeta as _PyTypedDictMeta  # type: ignore[attr-defined]
