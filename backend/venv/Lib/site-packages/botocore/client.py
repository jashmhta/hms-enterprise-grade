...
from botocore.httpchecksum import apply_request_checksum, resolve_checksum_context
    ...
    def _inject_s3_input_parameters(self, params, context, **kwargs):
        ...
        for inject_parameter in inject_parameters:
            if inject_parameter in params:
                context["input_params"][inject_parameter] = params[inject_parameter]
...
class BaseClient:
    ...
    def _make_api_call(self, operation_name, api_params):
        ...
        (
            ...
            additional_headers,
            properties,
        ) = self._resolve_endpoint_ruleset(operation_model, api_params, request_context)
        if properties:
