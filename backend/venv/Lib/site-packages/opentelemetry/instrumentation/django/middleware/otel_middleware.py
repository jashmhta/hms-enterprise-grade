...
from opentelemetry.instrumentation._semconv import (
    ...
    _report_new, _report_old, _server_active_requests_count_attrs_new,
    _server_active_requests_count_attrs_old, _server_duration_attrs_new,
    _server_duration_attrs_old, _StabilityMode)
from opentelemetry.instrumentation.propagators import \
    get_global_response_propagator
from opentelemetry.instrumentation.utils import (
    _start_internal_or_server_span, extract_attributes_from_object)
from opentelemetry.instrumentation.wsgi import add_response_attributes
from opentelemetry.instrumentation.wsgi import \
    collect_custom_request_headers_attributes as \
    wsgi_collect_custom_request_headers_attributes
from opentelemetry.instrumentation.wsgi import \
    collect_custom_response_headers_attributes as \
...
from opentelemetry.util.http import (
    ...
    get_custom_headers, get_excluded_urls, get_traced_request_attrs,
    normalise_request_header_name, normalise_response_header_name,
    sanitize_method)
...
try:
    ...
    from opentelemetry.instrumentation.asgi import \
        collect_custom_headers_attributes as \
