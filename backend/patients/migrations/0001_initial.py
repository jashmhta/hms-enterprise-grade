    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['hospital', 'last_name', 'first_name'], name='patients_pa_hospita_285e8f_idx'), models.Index(fields=['uuid'], name='patients_pa_uuid_6d5db2_idx')],
