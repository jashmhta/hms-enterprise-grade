...
def _encrypt_payload(payload: dict) -> dict:
	...
	return { 'encrypted': True, 'ciphertext_b64': base64.b64encode(cipher).decode('ascii') }


def send_audit_event(service: str, action: str, resource_type: str, resource_id: Optional[str] = None, detail: Optional[str] = None):
