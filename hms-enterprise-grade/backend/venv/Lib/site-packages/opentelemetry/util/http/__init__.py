...
from opentelemetry.semconv._incubating.attributes.http_attributes import (
    HTTP_FLAVOR, HTTP_HOST, HTTP_METHOD, HTTP_SCHEME, HTTP_SERVER_NAME,
    HTTP_STATUS_CODE)
from opentelemetry.semconv._incubating.attributes.net_attributes import (
    NET_HOST_NAME, NET_HOST_PORT)
            ...
            for header_name, header_value in headers.items():
                if header_regexes_compiled.fullmatch(header_name):
                    ...
                    if isinstance(header_value, str):
                        values[key] = [
                            self.sanitize_header_value(header_name, header_value)
                        ]
                    else:
                        values[key] = [
...
def _parse_duration_attrs(req_attrs):
    duration_attrs = {
        key: req_attrs[key] for key in _duration_attrs.intersection(req_attrs.keys())
    }
