...
class ExportProfilesServiceRequest(google.protobuf.message.Message):
    ...
    def resource_profiles(
        ...
        opentelemetry.proto.profiles.v1development.profiles_pb2.ResourceProfiles
    ]:
    ...
    def dictionary(
        self,
    ) -> opentelemetry.proto.profiles.v1development.profiles_pb2.ProfilesDictionary:
...
class ExportProfilesPartialSuccess(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "error_message", b"error_message", "rejected_profiles", b"rejected_profiles"
        ],
    ) -> None: ...
