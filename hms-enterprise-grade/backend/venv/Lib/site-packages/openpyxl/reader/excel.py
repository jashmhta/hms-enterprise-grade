...
from openpyxl.packaging.relationship import (RelationshipList, get_dependents,
                                             get_rels_path)
...
from openpyxl.xml.constants import (ARC_CONTENT_TYPES, ARC_CORE, ARC_CUSTOM,
                                    ARC_THEME, ARC_WORKBOOK, COMMENTS_NS,
                                    SHARED_STRINGS, XLSM, XLSX, XLTM, XLTX)
