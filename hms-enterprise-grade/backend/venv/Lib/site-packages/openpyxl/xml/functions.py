...
if LXML is True:
    from lxml.etree import (Element, QName, SubElement, XMLParser, fromstring,
                            register_namespace, tostring, xmlfile)
    ...
    from xml.etree.ElementTree import (Element, QName, SubElement, fromstring,
                                       register_namespace, tostring)
...
from openpyxl.xml.constants import (CHART_DRAWING_NS, CHART_NS, COREPROPS_NS,
                                    CUSTPROPS_NS, DCTERMS_NS, DCTERMS_PREFIX,
                                    DRAWING_NS, REL_NS, SHEET_DRAWING_NS,
                                    SHEET_MAIN_NS, VTYPES_NS, XML_NS)
