...
class ScramClient:
    ...
    def process_server_first_message(self, server_first_message):
        ...
        self.client_signature = self.hmac(
            self.stored_key, self.auth_message.encode("utf-8")
        )
        ...
        self.server_signature = self.hmac(
            self.server_key, self.auth_message.encode("utf-8")
        )
    ...
    def final_message(self):
        return "c=biws,r={},p={}".format(
            self.nonce, base64.b64encode(self.client_proof).decode("utf-8")
        )
