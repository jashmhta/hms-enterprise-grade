...
from sentry_sdk.utils import (ContextVar, json_dumps, nanosecond_time, now,
                              serialize_frame, to_timestamp)

if TYPE_CHECKING:
    from typing import (Any, Callable, Dict, Generator, Iterable, List,
                        Optional, Set, Tuple, Union)

    from sentry_sdk._types import (BucketKey, DurationUnit, FlushedMetricValue,
                                   MeasurementUnit, MetricMetaKey, MetricTags,
                                   MetricTagsInternal, MetricTagValue,
