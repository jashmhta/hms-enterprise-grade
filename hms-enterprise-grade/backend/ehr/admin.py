...
from .models import (
    Encounter, VitalSigns, Assessment, PlanOfCare, ClinicalNote,
    Allergy, EncounterAttachment
)


@admin.register(Encounter)
class EncounterAdmin(admin.ModelAdmin):
    list_display = ("patient", "primary_physician", "hospital", "appointment", "encounter_type", "encounter_status")
    list_filter = ("hospital", "primary_physician", "encounter_type", "encounter_status", "priority_level")
    search_fields = ("patient__first_name", "patient__last_name", "primary_physician__username", "encounter_number")
...
class VitalSignsAdmin(admin.ModelAdmin):
    list_display = ('encounter', 'recorded_by', 'temperature_celsius', 'systolic_bp', 'diastolic_bp', 'heart_rate', 'recorded_at')
...
class AssessmentAdmin(admin.ModelAdmin):
    list_display = ('encounter', 'diagnosis_type', 'diagnosis_code', 'diagnosis_description', 'status')
    list_filter = ('encounter__hospital', 'diagnosis_type', 'status', 'severity')
    search_fields = ('encounter__patient__first_name', 'encounter__patient__last_name', 'diagnosis_code', 'diagnosis_description')
...
class PlanOfCareAdmin(admin.ModelAdmin):
    ...
    search_fields = ('encounter__patient__first_name', 'encounter__patient__last_name', 'title', 'description')
...
class ClinicalNoteAdmin(admin.ModelAdmin):
    ...
    search_fields = ('encounter__patient__first_name', 'encounter__patient__last_name', 'content')
...
class EncounterAttachmentAdmin(admin.ModelAdmin):
    list_display = ('encounter', 'file_type', 'description', 'uploaded_by', 'created_at')
    list_filter = ('encounter__hospital', 'file_type', 'created_at')
    search_fields = ('encounter__patient__first_name', 'encounter__patient__last_name', 'description')
