...
def get_blood_bags(db: Session, skip: int = 0, limit: int = 100) -> List[models.BloodBag]:
...
def get_available_blood_bags(db: Session, blood_type: models.BloodType, component: models.BloodComponent) -> List[models.BloodBag]:
...
def create_transfusion(db: Session, transfusion: schemas.TransfusionCreate) -> models.Transfusion:
...
def create_blood_request(db: Session, blood_request: schemas.BloodRequestCreate) -> models.BloodRequest:
