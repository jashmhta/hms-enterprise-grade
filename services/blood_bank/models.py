...
class Donor(Base):
    ...
    eligibility_status = Column(String, default="pending")  # eligible, ineligible, pending
...
class BloodBag(Base):
    ...
    status = Column(String, default="available")  # available, reserved, transfused, discarded
...
class Donation(Base):
    ...
    status = Column(String, default="collected")  # collected, testing, approved, rejected
    created_at = Column(DateTime, default=datetime.utcnow)
...
class Transfusion(Base):
    ...
    status = Column(String, default="completed")  # scheduled, in-progress, completed, cancelled
    created_at = Column(DateTime, default=datetime.utcnow)
...
class BloodRequest(Base):
    ...
    status = Column(String, default="pending")  # pending, approved, fulfilled, cancelled
